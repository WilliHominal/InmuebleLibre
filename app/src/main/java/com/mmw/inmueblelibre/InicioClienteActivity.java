...
public class InicioClienteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cerrarSesionBTN = (Button) findViewById(R.id.INICIOCLI_cerrar_sesion_BTN);
        nombreUsuarioTV = (TextView) findViewById(R.id.INICIOCLI_bienvenido_TV);
        correoUsuarioTV = (TextView) findViewById(R.id.INICIOCLI_correo_TV);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.INICIOCLI_cerrar_sesion_BTN:
        ...
        databaseFirebase.child("Usuarios").child(id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    nombreUsuarioTV.setText("Bienvenido cliente " + nombre);
